...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
    ...
    },
    {
        ...
        category: "valuation",
        categoryLabel: "Định giá & Sinh lời",
        definition: "Giá trị hiện tại của toàn bộ các dòng tiền mà một doanh nghiệp được kỳ vọng sẽ tiếp tục tạo ra từ sau giai đoạn dự báo chi tiết (thường là sau năm thứ 5 hoặc thứ 10) cho đến mãi mãi.",
        formula: "TV = [FCF năm cuối × (1 + g)] / (WACC - g) hoặc TV = Bội số Exit Multiple × EBITDA năm cuối",
    ...
    },
    {
        ...
        category: "performance",
        categoryLabel: "Hiệu quả & Tài chính",
        definition: "Tỷ lệ giữa chi phí cố định (Fixed Costs) và chi phí biến đổi (Variable Costs) trong cấu trúc hoạt động sản xuất kinh doanh của một công ty.",
